...
const FullStack = () => {
  ...
  <h1 className='primaryHeading'>The Full Stack Path: Mastering the Art of Web Development</h1>
  <p className='content'>Full stack development is one of the most versatile and rewarding career paths in tech. Whether you're passionate about frontend aesthetics or backend logic, being a full stack developer allows you to bring ideas to life from concept to completion.</p>
  
  <h2 className='secondaryHeading'>Frontend Fundamentals</h2>

...
const BreakFear = () => {
  return (
    ...
    <h1 className='primaryHeading'>Break the Fear: Overcoming Obstacles to Success</h1>
    <p className='content'>Fear can be one of the greatest barriers to personal and professional success. Whether it&apos;s fear of failure, fear of change, or fear of the unknown, breaking through that fear is essential to achieving your full potential.</p>
    
    <h2 className='secondaryHeading'>Understanding Fear</h2>
